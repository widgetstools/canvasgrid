...
- [x] 21g-S1 (2026-07-02: branch cycle21g/edit off main @ 871181c per user directive — recon+spec committed there, not main; recon 1acd145 `plans/notes/2026-07-02-cycle-21g-recon.md`; spec 6143d38 `specs/2026-07-02-cycle-21g-edit-design.md`; all 4 open questions settled — cellKeyDown+preventDefault, one Tx per entry, snapshot/restore selection, bridge-owned mirror (no kernel getRowById); kernel-diff verdict ZERO; PR #98 declared HARD DEP for bridge/E2E, still open at session end so no sync/baseline update) · [ ] 21g-S2 · [ ] 21g-S3 · [ ] 21g-S4 · [ ] 21g-S5 · [ ] 21g-S6

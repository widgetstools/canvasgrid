...
| **21g-S3** | Engine I: journal core + cascade + patches + preview (Tasks 2-4). NO per-task reviews (user directive 2026-07-02: single closeout review when all tasks done) |
| **21g-S4** | Engine II: smart-edit + magnitude + bulk-update + plus/minus + shortcuts (Tasks 5-9) |
...
- [x] 21g-S1 (2026-07-02: branch cycle21g/edit off main @ 871181c per user directive — recon+spec committed there, not main; recon 1acd145 `plans/notes/2026-07-02-cycle-21g-recon.md`; spec 6143d38 `specs/2026-07-02-cycle-21g-edit-design.md`; all 4 open questions settled — cellKeyDown+preventDefault, one Tx per entry, snapshot/restore selection, bridge-owned mirror (no kernel getRowById); kernel-diff verdict ZERO; PR #98 declared HARD DEP for bridge/E2E, still open at session end so no sync/baseline update) · [x] 21g-S2 (2026-07-02: plan Tasks 1-12 complete @ 4590c9f; kernel seam getRowsByIndex APPROVED as spec §3.6a @ b30347d — visible-order row fetch has no public surface, genuine intrinsic need; Task 1 done @ 4497102 + review fix a1b827c, edit 13/13; recon C.9 corrected (isCellEditable/isEditing not public); USER DIRECTIVE: single closeout review for Tasks 2-12, no per-task reviewers) · [x] 21g-S3 (2026-07-02: Tasks 2-4 @ bc00bdf/374973f/d0d52d3 — journal core + cascade undoEntry + patches primitives + preview; edit 48/48, kernel-diff EMPTY; reviews deferred to closeout per directive) · [x] 21g-S4 (2026-07-02: Tasks 5-9 @ 54c3f9a/5117b5c/0d7771a/dd4138b/62b640c — smart-edit + magnitude + bulk-update + plus/minus + shortcuts; edit 127/127, kernel-diff EMPTY; full engine surface shipped) · [x] 21g-S5 (2026-07-02: Task 10 kernel getRowsByIndex @ bccec6f — kernel 2575/2575, scope = 3 files only, PR #98 still OPEN at re-check; Task 11 bridge @ 8b2e821 — 30 tests, edit 157/157; reviews at closeout) · [x] 21g-S6 (2026-07-03: Task 12 showcase+E2E @ dd9a694 — rowIdAt stub also blocks cellKeyDown nudges/shortcuts pre-#98, E2E 4/5/8 tripwired; closeout review NEEDS-FIXES → fix wave 9a9d66b (no re-parse on replay, editability in key router, journal copy, applied-count) → re-review READY TO MERGE; edit 161/161, kernel 2575/2575, E2E 158+6, build 13/13)
- [ ] 21h-S1 · [ ] 21h-S2 · [ ] 21h-S3 · [ ] 21h-S4
- [x] 21i-S0 (2026-07-03: recon redo committed `plans/notes/cycle-21i-customizer-recon.md` on cycle21i/customizer; decision session COMPLETE — 8 locked decisions: D-A hybrid attachment + Grid Options as schema-driven sidebar tab; D-B Lit+Web Awesome+CodeMirror 6 (not Monaco), dual-theme token bridge mandatory; D-C kernel module-state registry, TOTAL-state getState/setState; D-D nothing dropped, full native-vs-plugin assignment; D-E native/enterprise two-tier split; D-G app-extensible config slices + schema-driven Custom Settings; D-H native gridId + localStorage persistence w/ pluggable adapter; EXECUTION MODEL interactive phases w/ standalone STOMP-fed demo app. PHASE 1 scoped: grid options editor + basic formatting toolbar + engine prereqs + apps/cgrid-customizer-demo) · [x] 21i-S1 (2026-07-03: Phase 1 spec committed 1f7cd35 `specs/2026-07-03-cycle-21i-phase1-design.md` — T1-T6, gates G1/G2; T1 demo testbed @ 309adde — apps/cgrid-customizer-demo on :5187, 5k rows + 300 upd/s live from stomp-view-server, dual-theme chrome, format DSL wired [note: string valueFormatter without wired compiler throws per-cell 'valueFormatter is not a function' — kernel robustness item for closeout review]; T2 persistState @ 0516d0c — kernel 2591/2591, live round-trip verified) · **next: 21i-S2** (T3+T4 schema engine + Grid Options tab — /frontend-design FIRST, then build → UX gate G1 with user)

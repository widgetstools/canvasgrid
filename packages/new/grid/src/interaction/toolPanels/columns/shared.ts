...
/** Re-exported so the zone panels keep their existing import site. The
 *  constant itself is owned by `dragController`, which is the one place
 *  the grid's drag budget is declared. */
export { DRAG_THRESHOLD_PX } from '../../dragController';

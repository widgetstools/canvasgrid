...
export interface VelocityGridApi<TRow = any> {
   ...
   *  @wellsfargo-starui/vg-new-engines's wireIntoKernel). Kernel folds its synthesized calc
  ...
  // The shared styling-template library, routed to `@wellsfargo-starui/vg-new-engines`. When no
  ...
  getTemplates(): import('@wellsfargo-starui/vg-new-engines').ColumnTemplate[];
  ...
  editColumn(colId: string, patch: import('@wellsfargo-starui/vg-new-engines').ColumnEditPatch): void;

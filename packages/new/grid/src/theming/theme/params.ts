...
const SCALAR_PARAMS: readonly ScalarParamSpec[] = [
  ...
  // Dead token — compiles to a CSS var that `CssReader` reads into
  // `ResolvedTheme.cellHorizontalBorderColor` and no painter consumes.
  // Kept in lockstep with that field; see its doc in `cssReader.ts`.
  {

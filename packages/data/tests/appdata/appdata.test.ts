...
describe('LocalStorageAppDataStore', () => {
  ...
  it('round-trips bags across instances', async () => {
    const { LocalStorageAppDataStore, appDataStorageKey } = await import('../../src/appdata/localStorageStore');
  ...
  it('accepts an injected MemoryStore', async () => {
    const { PersistedAppDataStore, appDataStorageKey } = await import('../../src/appdata/localStorageStore');
    const { MemoryStore } = await import('../../src/storage/index');

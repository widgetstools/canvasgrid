// @wellsfargo-starui/velocity-grid-ext/edit — numericOps.test.ts
...
import { applyNumericOp, isNumericCellDataType } from '../../src/edit/numericOps';
import type { SmartEditOp } from '../../src/edit/types';

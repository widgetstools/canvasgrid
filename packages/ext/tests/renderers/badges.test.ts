// @wellsfargo-starui/velocity-grid-ext/renderers — badges category tests (Cycle 21f / Task 8).
...
} from '../../src/renderers/palette';
import { withAlpha } from '../../src/renderers/paintUtils';
import {
  statusPill, ratingBadge, ratingClusterCell, tagCell, venueChip, sideChip, tifPill,
} from '../../src/renderers/badges';

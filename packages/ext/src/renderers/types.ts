// @wellsfargo-starui/velocity-grid-ext/renderers — canonical renderer name table + public param types.
...
/**
 * Every canonical `cellRenderer` name `@wellsfargo-starui/velocity-grid-ext/renderers` registers. 46 new

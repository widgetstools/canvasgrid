// @wellsfargo-starui/velocity-grid-ext/renderers — the kernel bridge. §2.5.
//
...
/**
 * Wire `@wellsfargo-starui/velocity-grid-ext/renderers` into a VelocityGrid instance. Idempotent — re-calling on

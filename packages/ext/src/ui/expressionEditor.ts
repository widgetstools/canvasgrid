    ...
    this.view = new EditorView({
      ...
      state: EditorState.create({
        ...
        extensions: [
          ...
          // NOTE: no custom tooltip parent — a body-parented container is
          // IN FLOW at the end of <body> and grows the page (stray
          // scrollbars). In-editor tooltips position absolutely and clip
